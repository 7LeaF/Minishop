...
<p style="padding-left:10px;"><a href="main.do">홈</a> > <a href="ProductList.do?category_code=all">상품보기</a> > 결제하기</p>
           ...
           <table id="mytable" class="table table-custom">
			...
			<thead>
  			...
  			<tbody>
				...
				<td>${vo.priceSale}</td>
			    <td>${param.productQnty}</td>
			    <td style="text-align: left;">판매가 : ${vo.priceSale}원<br>배송비 : 5000원<br>총 결제금액 : ${vo.priceSale*param.productQnty+5000}</td>
			    </tr>
   			</tbody>
		</table>
	</div>
	...
	<input type="hidden" value="${param.productQnty}" name= "orderCount">
	<input type="hidden" value="${param.productCode}" name= "productCode">
	
	<div class="row">
	<div class="col-md-6">
		<h2><small>주문자 정보</small></h2>
		
				<div class="form-group">
				  <label for="buyerName">이름:</label>
				  <input type="text" class="form-control" placeholder="주문자 이름" name="buyerName">
				</div>
				
				<div class="form-group">
				  <label for="userAddress1">주소:</label>
				  <input type="text" class="form-control" placeholder="주문자 주소1" name="buyerAddress1">
				  <label for="userAddress2"></label>
				  <input type="text" class="form-control" placeholder="주문자 주소2" name="buyerAddress2">
				</div>
				
				<div class="form-group">
				  <label for="buyerPhone">전화번호:</label>
				  <input type="text" class="form-control" placeholder="휴대전화번호 ('-' 없이 입력해주세요.)" name="buyerPhone">
				</div>
				
				<div class="form-group">
				  <label for="buyerEmail">이메일:</label>
				  <input type="email" class="form-control" placeholder="이메일 주소" name="buyerEmail">
				</div>		
	</div>
	
	<div class="col-md-6">
		<h2><small>배송지 정보</small></h2>
		
				<div class="form-group">
				  <label for="rcptName">이름:</label>
				  <input type="text" class="form-control" placeholder="수신자 이름" name="rcptName">
				</div>
				
				<div class="form-group">
				  <label for="rcptAddress1">주소:</label>
				  <input type="text" class="form-control" placeholder="수신자 주소1" name="rcptAddress1">
				  <label for="rcptAddress2"></label>
				  <input type="text" class="form-control" placeholder="수신자 주소2" name="rcptAddress2">
				</div>
				
				<div class="form-group">
				  <label for="rcptPhone">전화번호:</label>
				  <input type="text" class="form-control" placeholder="휴대전화번호 ('-' 없이 입력해주세요.)" name="rcptPhone">
				</div>
